...
class PacientesTest < ApplicationSystemTestCase
  ...
  test "creating a Paciente" do
    ...
    fill_in "First name", with: @paciente.first_name
    fill_in "Historial", with: @paciente.historial
    fill_in "Last name", with: @paciente.last_name
    fill_in "Phone", with: @paciente.phone
