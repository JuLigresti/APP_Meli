...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { email: @paciente.email, first_name: @paciente.first_name, historial: @paciente.historial, last_name: @paciente.last_name, phone: @paciente.phone } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { email: @paciente.email, first_name: @paciente.first_name, historial: @paciente.historial, last_name: @paciente.last_name, phone: @paciente.phone } }
